...
class User extends Manager
{
	...
	protected $readingFields = "u_nickname, DATE_FORMAT(u_datetime, '%d/%m/%Y à %Hh%imin')AS u_datetime, u_email, u_password, u_role, u_number_speech";
	protected $values = ":u_nickname, NOW(), :u_email, :u_password, :u_role, :u_number_speech";
