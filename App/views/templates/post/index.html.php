			...
			<form class="marg-top" id="formPostAjax"  method="post">
				<div class="control-group">
					<div class="form-group col floating-label-form-group controls">
						...
						<textarea rows="3" class="form-control tinymce-edition" name="p_extract" placeholder="Tapez votre commentaire" id="p_extract"></textarea>

						<label for="p_content">Contenu de votre article</label>
						<textarea rows="10" class="form-control tinymce-edition" name="p_content" placeholder="Tapez votre commentaire" id="p_content"></textarea>
					</div>
				</div>
				<br>
